...
image_clienticons = Image("clienticons", "client_icons.png", 1)
...
set_clienticons = SpriteSet("clienticons", image_clienticons, 3, 1)
...
container.sprites.Add(Sprite("gamericon", set_clienticons, 0,0,1,1))
container.sprites.Add(Sprite("zillyicon", set_clienticons, 1,0,1,1))
container.sprites.Add(Sprite("fclienticon", set_clienticons, 2,0,1,1))
