...
MACRO_CONFIG_STR(DummySkinBody, dummy_skin_body, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin body")
MACRO_CONFIG_STR(DummySkinMarking, dummy_skin_marking, 24, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin marking")
MACRO_CONFIG_STR(DummySkinDecoration, dummy_skin_decoration, 24, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin decoration")
MACRO_CONFIG_STR(DummySkinHands, dummy_skin_hands, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin hands")
MACRO_CONFIG_STR(DummySkinFeet, dummy_skin_feet, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin feet")
MACRO_CONFIG_STR(DummySkinEyes, dummy_skin_eyes, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin eyes")
