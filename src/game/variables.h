...
MACRO_CONFIG_INT(ClShowUserId, cl_show_user_id, 0, 0, 2, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Show the ID for every user (2=show except in nameplate)")
...
MACRO_CONFIG_INT(DummyColorBody, dummy_color_body, 0x1B6F74, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy body color")
MACRO_CONFIG_INT(DummyColorMarking, dummy_color_marking, 0xFF0000FF, 0, 0, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy marking color")
MACRO_CONFIG_INT(DummyColorDecoration, dummy_color_decoration, 0x1B6F74, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy decoration color")
MACRO_CONFIG_INT(DummyColorHands, dummy_color_hands, 0x1B759E, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy hands color")
MACRO_CONFIG_INT(DummyColorFeet, dummy_color_feet, 0x1C873E, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy feet color")
MACRO_CONFIG_INT(DummyColorEyes, dummy_color_eyes, 0x0000FF, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy eyes color")
MACRO_CONFIG_INT(DummyUseCustomColorBody, dummy_use_custom_color_body, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of dummy custom colors for body")
MACRO_CONFIG_INT(DummyUseCustomColorMarking, dummy_use_custom_color_marking, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of dummy custom colors for marking")
MACRO_CONFIG_INT(DummyUseCustomColorDecoration, dummy_use_custom_color_decoration, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of dummy custom colors for decoration")
MACRO_CONFIG_INT(DummyUseCustomColorHands, dummy_use_custom_color_hands, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of dummy custom colors for hands")
MACRO_CONFIG_INT(DummyUseCustomColorFeet, dummy_use_custom_color_feet, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of dummy custom colors for feet")
MACRO_CONFIG_INT(DummyUseCustomColorEyes, dummy_use_custom_color_eyes, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of dummy custom colors for eyes")
MACRO_CONFIG_UTF8STR(DummySkin, dummy_skin, MAX_SKIN_ARRAY_SIZE, MAX_SKIN_LENGTH, "default", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin")
MACRO_CONFIG_UTF8STR(DummySkinBody, dummy_skin_body, MAX_SKIN_ARRAY_SIZE, MAX_SKIN_LENGTH, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin body")
MACRO_CONFIG_UTF8STR(DummySkinMarking, dummy_skin_marking, MAX_SKIN_ARRAY_SIZE, MAX_SKIN_LENGTH, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin marking")
MACRO_CONFIG_UTF8STR(DummySkinDecoration, dummy_skin_decoration, MAX_SKIN_ARRAY_SIZE, MAX_SKIN_LENGTH, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin decoration")
MACRO_CONFIG_UTF8STR(DummySkinHands, dummy_skin_hands, MAX_SKIN_ARRAY_SIZE, MAX_SKIN_LENGTH, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin hands")
MACRO_CONFIG_UTF8STR(DummySkinFeet, dummy_skin_feet, MAX_SKIN_ARRAY_SIZE, MAX_SKIN_LENGTH, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin feet")
MACRO_CONFIG_UTF8STR(DummySkinEyes, dummy_skin_eyes, MAX_SKIN_ARRAY_SIZE, MAX_SKIN_LENGTH, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy skin eyes")
